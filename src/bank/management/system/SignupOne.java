...
public class SignupOne extends JFrame implements ActionListener{
    ...
    SignupOne() {
        ...
        JLabel personalDetails = new JLabel("STEP 1: Personal Details");
        ...
        dateChooser = new JDateChooser();  //For apply Calendar
